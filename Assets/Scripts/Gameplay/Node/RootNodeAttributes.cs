...
public class RootNodeAttributes : MonoBehaviour
{
    ...
    public void UpdateNutrientValue(){
        ...
        henderance = outLen;
        nutrient = Mathf.RoundToInt((rootLength * 10f) * (thickness * 1.5f)) - henderance + distOffset;
    }
    ...
    public bool CanUpgrade(){
        int cost = GetUpgradeCost();
        return (TreeAttributes.storedNutrients >= cost && ThinnerThanParent());
    }

    public bool ThinnerThanParent(){
        int cost = GetUpgradeCost();
